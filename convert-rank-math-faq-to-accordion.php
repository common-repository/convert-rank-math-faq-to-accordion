...
* Description:          Transforms Rank Math FAQ blocks into an interactive accordion. Customize colors, fonts, and styles easily.
* Version:              1.0.2
...
define( 'INBRMFA_CURRENT_VERSION', '1.0.2' );
